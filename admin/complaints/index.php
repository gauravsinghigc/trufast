                          ...
                          <a href="details/?id=<?php echo $Complaint->ComplaintsId; ?>">
                            <div class="data-list pb-2">
                              ...
                              <span>
                                ...
                                <span class="bold">
                                  <a href="details/?id=<?php echo $Complaint->ComplaintsId; ?>"><i class="fa fa-user"></i> <?php echo FETCH("SELECT * FROM users Where UserID='" . $Complaint->ComplaintsUserId . "'", "UserFullName"); ?></a>
