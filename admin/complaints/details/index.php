...
$ProSql = "SELECT * FROM complaint_products where MainComplaintId='$ComplaintsId'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <h5 class="app-sub-heading">Product/Item Details
                        <a class="pull-right" href="update-warn-pro.php?proid=<?php echo SECURE(FETCH($ProSql, "ComplaintProductId"), "e"); ?>"><i class='fa fa-edit'></i></a>
                      </h5>
                      <p class="data-list">
                        <span class="text-grey">Warranty Status</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductWarrantyStatus"); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Product name</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductName"); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Product Serial No</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductSerialNo"); ?></span>
                      </p>


                      <p class="data-list">
                        <span class="text-grey">Modal No</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductModalNo"); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Speciality</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductSpeciality"); ?> AH</span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Warranty in Months</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductWarrantyInMonths"); ?> Months</span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Life</span><br>
                        <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductLifeInYears"); ?> Years</span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Mfg Date</span><br>
                        <span class="bold"><?php echo DATE_FORMATE2("d M, Y", FETCH($ProSql, "ComplaintProductMfgDate")); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Purchase Date</span><br>
                        <span class="bold"><?php echo DATE_FORMATE2("d M, Y", FETCH($ProSql, "ComplaintProductPurchaseDate")); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Expire Date</span><br>
                        <span class="bold"><?php echo DATE_FORMATE2("d M, Y", FETCH($ProSql, "ComplaintProductWarrantyExpireAt")); ?></span>
                      </p>
                    </div>
                    ...
                    <div class="col-md-5">
                      ...
                      <div class="chat-box">
                        <div class="chat-area">
                          ...
                          <p class="data-list">
                            ...
                            <span class="text-grey">Product Serial No</span><br>
                            <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductSerialNo"); ?></span><br>
                            <span class="text-grey">Modal No</span><br>
                            <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductModalNo"); ?></span><br>
                            <span class="text-grey">Capacity</span><br>
                            <span class="bold"><?php echo FETCH($ProSql, "ComplaintProductSpeciality"); ?></span><br>
                            <hr class="w-25">
                          </p>
                      ...
                      <hr>
                      <h5 class="app-sub-heading "><i class='fa fa-inr text-success'></i> Add Service Charges</h5>
                      <?php
                      $CheckCharges = CHECK("SELECT * FROM complaint_charges where complaint_main_id='$ComplaintsId'");
                      if ($CheckCharges == null) { ?>
                        <form action="<?php echo CONTROLLER; ?>/ComplaintController.php" method="POST">
                          <?php FormPrimaryInputs(true, [
                            "complaint_main_id" => $ComplaintsId
                          ]); ?>
                          <div class="form-group">
                            <label>Charge Name</label>
                            <input type="text" name="complaint_charge_name" class="form-control" placeholder="Charge Name">
                          </div>
                          <div class="form-group">
                            <label>Applicable Tax (in %)</label>
                            <select name="complaint_charge_tax_amount" class="form-control" required>
                              <?php InputOptions(["0", "5", "7", "10", "12", "15", "18", "20", "25", "30"], "0"); ?>
                            </select>
                          </div>
                          <div class="form-group">
                            <label>Charge Amount (in Rs.)</label>
                            <input type="text" name="complaint_charge_amount" class="form-control" placeholder="Charge Amount">
                          </div>
                          <div class="form-group">
                            <button name="AddCharges" class="btn btn-md btn-success">Add Charges</button>
                          </div>
                        </form>
                      <?php } else {
                        $ChargeSql = "SELECT * FROM complaint_charges where complaint_main_id='$ComplaintsId'"; ?>
                        <form action="<?php echo CONTROLLER; ?>/ComplaintController.php" method="POST">
                          <?php FormPrimaryInputs(true, [
                            "complaint_charge_idc" => FETCH($ChargeSql, "complaint_charge_idc")
                          ]); ?>
                          <div class="form-group">
                            <label>Charge Name</label>
                            <input type="text" name="complaint_charge_name" value="<?php echo FETCH($ChargeSql, "complaint_charge_name"); ?>" class="form-control" placeholder="Charge Name">
                          </div>
                          <div class="form-group">
                            <label>Applicable Tax (in %)</label>
                            <select name="complaint_charge_tax_amount" class="form-control" required>
                              <?php InputOptions(["0", "5", "7", "10", "12", "15", "18", "20", "25", "30"], FETCH($ChargeSql, "complaint_charge_tax_amount")); ?>
                            </select>
                          </div>
                          <div class="form-group">
                            <label>Charge Amount (in Rs.)</label>
                            <input type="text" name="complaint_charge_amount" value="<?php echo FETCH($ChargeSql, "complaint_charge_amount"); ?>" class="form-control" placeholder="Charge Amount">
                          </div>

                          <?php if (LOGIN_UserType == "Admin") {
                            $ChargeStatus = "";
                          } else {
                            $ChargeStatus = "disabled readonly";
                          } ?>
                          <div class="form-group">
                            <label>Payment Status</label>
                            <select name="complaint_charge_status" class="form-control" <?php echo $ChargeStatus; ?>>
                              <?php echo InputOptions(["UN-PAID", "PAID"], FETCH($ChargeSql, "complaint_charge_status")); ?>
                            </select>
                          </div>
                          <div class="form-group">
                            <button name="UpdateCharges" class="btn btn-md btn-success">Update Charges</button>
                          </div>
                        </form>
                      <?php } ?>
