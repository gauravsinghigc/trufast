                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <form action="add-complaint-details.php" method="GET">
                        ...
                        <div class="row">
                          <div class="col-md-12 text-right">
                            <button type="submit" name="CreateWarrantyCard" class="btn btn-md btn-success">Enter Complaint Details <i class="fa fa-angle-right"></i></button>
                          </div>
                        </div>
                      </form>
                    </div>
