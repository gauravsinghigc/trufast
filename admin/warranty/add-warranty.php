           ...
           <?php if (isset($_GET['UserPhoneNumber'])) {
            ...
            if ($FetchCustomers == null) {
             ...
             ?>
              <div class="data-list">
               <div class='p-2'>
                <span class="fs-20px bold"><?php echo $Customers->UserSalutation; ?></span>
                <span class="fs-20px bold"><?php echo $Customers->UserFullName; ?></span>
                ...
                <hr>
                <a href="select-item.php?customer_id=<?php echo SECURE($UserId, "e"); ?>" class="btn btn-sm btn-success">Select & Continue <i class="fa fa-angle-right"></i></a>
                ...
                <div style="display:none;" id="Update_<?php echo $Customers->UserId; ?>">
                 ...
                 <form action="../../controller/ComplaintController.php" method="POST">
                  <?php FormPrimaryInputs(
                   $Url = ADMIN_URL . "/warranty/select-item.php",
                   [
                    "UserId" => $UserId
                   ]
                  ); ?>
