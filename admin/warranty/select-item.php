        ...
        <div class="card-body">
         ...
         <div class="row">
          <div class="col-md-12 mb-1">
           <div class="flex-s-b">
            <a href="add-warranty.php" class="btn btn-sm btn-default mb-0 action-btn mr-1"><i class="fa fa-angle-left"></i></a>
           ...
           if ($FetchCustomers == null) {
            ...
            ?>
             <p class="shadow-sm p-2 rounded-1 pb-20px">
              ...
              <a href="add-warranty.php" class="btn btn-sm btn-success"><i class="fa fa-angle-left"></i> Change Customer</a>
             </p>
            ...
            <form action="<?php echo CONTROLLER; ?>/WarrantyController.php" method="POST">
             ...
             <div class="row">
              <div class="col-md-12 text-right">
               <button type="submit" name="CreateWarrantyCard" class="btn btn-lg btn-success">Create Warranty Card <i class="fa fa-angle-right"></i></button>
              </div>
             </div>
            </form>
           <?PHP } ?>
