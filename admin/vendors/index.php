...
//pagevariables
$PageName = "All Users";
$PageDescription = "Manage Vendors";
?>
<!DOCTYPE html>
<html lang="en">
                      ...
                      <form class="row">
                        <div class="col-md-4 mb-3">
                          <div class="flex-s-b">
                            ...
                            <?php SUGGEST_SQL_DATA("SELECT * FROM users where UserType='SERVICE_EXECUTIVE'", "UserFullName", "ASC"); ?>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          if (isset($_GET['UserFullName'])) {
                            ...
                            $AllCustomers = FetchConvertIntoArray("SELECT * FROM users where UserFullName like '%$UserFullName%' and UserType='VENDOR' ORDER BY UserId Desc", true);
                          } else {
                            $AllCustomers = FetchConvertIntoArray("SELECT * FROM users where UserType='VENDOR' ORDER BY UserId Desc", true);
                          }
                          ...
                          ?>
                              <tr>
                                ...
                                <td><?php echo $Customers->UserType; ?></td>
                                <td><?php echo DATE_FORMATE2("d M, Y", $Customers->UserCreatedAt); ?></td>
                                <td><?php echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='" . $Customers->UserId . "'"); ?> Complaints</td>
                                <td>
                                  <a href="details/?uid=<?php echo SECURE($Customers->UserId, "e"); ?>" class="btn btn-xs btn-success">View Details</a>
                                </td>
                              </tr>
                          <?php
                            }
