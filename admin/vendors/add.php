                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo CONTROLLER; ?>/usercontroller.php" method="POST">
                        ...
                        <h5 class="app-sub-heading">Add user details</h4>
                          ...
                          <div class="row mb-10px">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12">
                              ...
                              <input type="text" name="UserCompanyName" class="form-control">
                            </div>
                          </div>
                          <div class="row mb-10px">
                            <div class="col-md-12">
                    ...
                    <div class="row mb-10px mb-20px">
                      <div class="form-group col-lg-12 col-md-12 col-12">
                        <button class="btn btn-md btn-success" type="submit" name="SaveUsers"><i class="fa fa-check-circle"></i> Create User</button>
