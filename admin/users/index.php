                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          if (isset($_GET['UserFullName'])) {
                            ...
                            $AllCustomers = FetchConvertIntoArray("SELECT * FROM users where UserFullName like '%$UserFullName%' and UserType='SERVICE_EXECUTIVE' ORDER BY UserId Desc", true);
                          } else {
                            $AllCustomers = FetchConvertIntoArray("SELECT * FROM users where UserType='SERVICE_EXECUTIVE' ORDER BY UserId Desc", true);
                          }
