 <section class='pop-window' id="AddOffersCredits">
   <div class="container">
     <div class="row">
       <div class="col-md-12">
         <h5 class='app-heading'>Add New Offers Credit</h5>
       </div>
     </div>
     <form action="<?php echo CONTROLLER; ?>/OfferController.php" enctype="multipart/form-data" method="POST" class="row">
            ...
            if ($FetchAllActiveOffers != null) { ?>
             ...
             <?php
              foreach ($FetchAllActiveOffers as $Offer) { ?>
               <option value='<?php echo $Offer->OfferId; ?>'><?php echo $Offer->OfferName; ?></option>
           <?php }
            } else {
       ...
       <div class='col-md-4'>
         ...
         <input type='text' name='offer_on_modal_no' class="form-control" required=''>
       </div>
       <div class='col-md-4'>
         <label>Credit Amount/Registration</label>
         <input type='text' name='offer_credit_amount' class="form-control" required=''>
       </div>


       <div class="col-md-12 mt-3 text-right">
         <a href="#" onclick="Databar('AddOffersCredits')" class="btn btn-sm btn-default">Cancel</a>
         <button type="submit" name="SaveOfferCreditDetails" class="btn btn-sm btn-success"><i class="fa fa-check"></i> Save Record</button>
       </div>
     </form>
   </div>
 </section>