         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                 ...
                 <li class="nav-item">
                     <a href="<?php echo ADMIN_URL; ?>/transactions" class="nav-link">
                         <i class="nav-icon fas fa-exchange"></i>
                         <p>
                             All Service Charges
                         </p>
                 ...
                 <li class="nav-item">
                     <a href="<?php echo ADMIN_URL; ?>/users" class="nav-link">
                         <i class="nav-icon fas fa-users"></i>
                         <p>
                             All Service Executives
                         </p>
                     </a>
                 </li>
                 <li class="nav-item">
                     <a href="<?php echo ADMIN_URL; ?>/vendors" class="nav-link">
                         <i class="nav-icon fas fa-users"></i>
                         <p>
                             All Vendors
                         </p>
                 ...
                 <li class="nav-item">
                     <a href="<?php echo ADMIN_URL; ?>/rewards" class="nav-link">
                 ...
                 <li class="nav-item">
                     <a href="<?php echo ADMIN_URL; ?>/offers" class="nav-link">
