        ...
        <tr>
          ...
          <td>
            ...
            <span>
              ...
              $RegId = FETCH($WarnSql, "warranty_main_reg_id");
              $VendorId = FETCH("SELECT * FROM registrations where registrations_id='$RegId'", "registration_vendor_id"); ?>
            </span>
          </td>
        </tr>
      </table>
      <h3>Seller Details</h3>
      <h4 style='margin-top:0px;margin-bottom:0px !important;'><?php echo FETCH("SELECT * FROM users where UserId='" . $VendorId . "'", "UserCompanyName"); ?></h4>
      <p>
        <span><b>Owner Name</b> : <?php echo FETCH("SELECT * FROM users where UserId='" . $VendorId . "'", "UserFullName"); ?></span><br>
        <span><b>Phone Number</b> : <?php echo FETCH("SELECT * FROM users where UserId='" . $VendorId . "'", "UserPhoneNumber"); ?></span><br>
        <span><b>Email-id</b> : <?php echo FETCH("SELECT * FROM users where UserId='" . $VendorId . "'", "UserEmailId"); ?></span><br>
      </p>
      <img src="<?php echo STORAGE_URL_D; ?>/tool-img/<?php echo $warranty; ?>" style="width:100px;float:right;margin-top:-120px;margin-right:20px;">
    </div>
  </section>
</body>
