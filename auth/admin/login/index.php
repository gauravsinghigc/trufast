            ...
            <div class="card-body">
                <form action="<?php echo CONTROLLER; ?>/authcontroller.php" method="POST" class="fs-13px">
                    ...
                    <div class="form-group mb-15px">
                        ...
                        <input type="email" class="form-control h-40px fs-13px" required name="UserEmailId" placeholder="Email Address" id="emailAddress" />
                    </div>
                    <div class="form-group mb-15px">
                        <label for="password" class="fs-13px text-gray-600">Password</label>
                        <input type="password" name="UserPassword" required class="form-control h-40px fs-13px" placeholder="Password" id="password" />
                    </div>
                    ...
                    <div class='mb-10px text-dark'>
                        <p class='small'>
                            <i class='fa fa-check text-success'></i> By continue this, you agrees our
                            <a href="<?php echo DOMAIN; ?>/privacy-policy.php"><b>Privacy Policy</b></a>
                        </p>
                    </div>
                    <div class="mb-15px">
