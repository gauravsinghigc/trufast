...
if (isset($_POST['AddNewCustomer'])) {
    ...
    //complaint products
    $complaint_products = [
        "MainComplaintId" => $ComplaintMainComplaintId,
        "ComplaintProductName" => $_SESSION['ProductName'],
        "ComplaintProductSerialNo" => $_SESSION['WarrantyProductSno'],
        "ComplaintProductModalNo" => $_SESSION['WarrantyProductModalNo'],
        "ComplaintProductMfgDate" => $_SESSION['WarrantyProductMfgDate'],
        "ComplaintProductPurchaseDate" => $_SESSION['WarrantyProductPurchasedate'],
        "ComplaintProductSpeciality" => $_SESSION['WarrantyProductCapacity'],
        "ComplaintProductWarrantyInMonths" => $_SESSION['WarrantyProductMonthWarranty'],
        "ComplaintProductLifeInYears" => $_SESSION['WarrantyProductLife'],
        "ComplaintProductWarrantyExpireAt" => $_SESSION['WarrantyExpireDate'],
        "ComplaintProductWarrantyStatus" => $_SESSION['WarrantyStatus'],
        "ComplaintProductAddedAt" => RequestDataTypeDate,
        "ComplaintProductUpdatedAt" => RequestDataTypeDate,
    ];
    ...
    $Update = UPDATE("UPDATE complaints SET ComplaintStatus='EXECUTIVE ASSIGNE' where ComplaintsId='$ComplaintsId'");
    ...
    //update complaint product details
} elseif (isset($_POST['UpdateComplaintProducts'])) {
    $ComplaintProductId = SECURE($_POST['ComplaintProductId'], "d");

    //complaint products
    $complaint_products = [
        "ComplaintProductName" => $_POST['ComplaintProductName'],
        "ComplaintProductSerialNo" => $_POST['ComplaintProductSerialNo'],
        "ComplaintProductModalNo" => $_POST['ComplaintProductModalNo'],
        "ComplaintProductMfgDate" => $_POST['ComplaintProductMfgDate'],
        "ComplaintProductPurchaseDate" => $_POST['ComplaintProductPurchaseDate'],
        "ComplaintProductSpeciality" => $_POST['ComplaintProductSpeciality'],
        "ComplaintProductWarrantyInMonths" => $_POST['ComplaintProductWarrantyInMonths'],
        "ComplaintProductLifeInYears" => $_POST['ComplaintProductLifeInYears'],
        "ComplaintProductWarrantyExpireAt" => $_POST['ComplaintProductWarrantyExpireAt'],
        "ComplaintProductWarrantyStatus" => $_POST['ComplaintProductWarrantyStatus'],
        "ComplaintProductUpdatedAt" => RequestDataTypeDate,
    ];
    $Response = UPDATE_DATA("complaint_products", $complaint_products, "ComplaintProductId='$ComplaintProductId'");
    RESPONSE($Response, "Complaint Product Updated Successfully!", "Unable to update complaint products!");

    //add complaint charges
} elseif (isset($_POST['AddCharges'])) {
    $complaint_main_id = SECURE($_POST['complaint_main_id'], "d");

    $complaint_charges = [
        "complaint_main_id" => $complaint_main_id,
        "complaint_charge_name" => $_POST['complaint_charge_name'],
        "complaint_charge_amount" => $_POST['complaint_charge_amount'],
        "complaint_charge_tax_amount" => $_POST['complaint_charge_tax_amount'],
        "complaint_charge_status" => "UN-PAID",
        "complaint_charge_added_at" => RequestDataTypeDate,
        "complaint_charge_added_by" => LOGIN_UserId,
        "complaint_charge_updated_at" => RequestDataTypeDate,
        "complaint_charge_updated_by" => LOGIN_UserId,
    ];
    $Response = INSERT("complaint_charges", $complaint_charges);
    RESPONSE($Response, "Complaint charges are saved successfully!", "Unable to save complaint charges!");

    //update charge details 
} elseif (isset($_POST['UpdateCharges'])) {
    $complaint_charge_idc = SECURE($_POST['complaint_charge_idc'], "d");

    if ($_POST['complaint_charge_status'] == "PAID") {
        $complaint_charge_receive_at = RequestDataTypeDate;
        $complaint_charge_receive_by = LOGIN_UserId;
    } else {
        $complaint_charge_receive_at = "";
        $complaint_charge_receive_by = "";
    }
    ...
    $complaint_charges = [
        ...
        "complaint_charge_amount" => $_POST['complaint_charge_amount'],
        "complaint_charge_tax_amount" => $_POST['complaint_charge_tax_amount'],
        "complaint_charge_status" => $_POST['complaint_charge_status'],
        "complaint_charge_updated_at" => RequestDataTypeDate,
        "complaint_charge_updated_by" => LOGIN_UserId,
        "complaint_charge_receive_at" => $complaint_charge_receive_at,
        "complaint_charge_receive_by" => $complaint_charge_receive_by
    ];
    $Response = UPDATE_DATA("complaint_charges", $complaint_charges, "complaint_charge_idc='$complaint_charge_idc'");
    RESPONSE($Response, "Complaint charges are updated successfully!", "Unable to update complaint charges!");
}
