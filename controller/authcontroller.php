...
if (isset($_POST['LoginRequest'])) {
  ...
  $Update = UPDATE("UPDATE users SET UserUpdatedAt='$UserUpdatedAt', UserFullName='$UserName', UserPhoneNumber='$UserPhone', UserEmailId='$UserEmailId' where UserId='" . LOGIN_UserId . "' ");
