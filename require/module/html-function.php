  ...
  <section class="popup-background" id="<?php echo $id; ?>">
    <div class="action-area">
      ...
      <div class="activity-action">
        <a onclick="Databar('<?php echo $id; ?>')" class="btn btn-sm btn-danger"><?php echo ActionDeleteCancel; ?></a>
        <a href="<?= $Controller_Requests ?>" class="btn btn-sm btn-success"><?php echo ActionDeleteConfirm; ?></a>
      </div>
    </div>
  </section>
  <?php }
